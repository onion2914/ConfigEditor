...
namespace ConfigEditor.Intellisense
{
    ...
    [Name("Config commit manager provider")]
    [ContentType("config")]
    class ConfigCompletionCommitManagerProcider : IAsyncCompletionCommitManagerProvider
    {
        ...
        public IAsyncCompletionCommitManager GetOrCreate(ITextView textView)
        {
            ...
            var manager = new ConfigCompletionCommitManager();
