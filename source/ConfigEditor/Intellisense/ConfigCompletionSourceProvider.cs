...
namespace ConfigEditor.Intellisense
{
    ...
    [Name("config completion provider")]
    [ContentType("config")]
    class ConfigCompletionSourceProvider : IAsyncCompletionSourceProvider
    {
        ...
        public IAsyncCompletionSource GetOrCreate(ITextView textView)
        {
            ...
            var source = new ConfigCompletionSource(Catalog, StructureNavigatorSelector); // opportunity to pass in MEF parts
